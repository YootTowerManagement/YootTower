...
Bill Bowman is listed in the Smalltalk acknowledgments among people from other PARC groups who assisted the project.
...
David Canfield Smith is listed among students in the Smalltalk acknowledgments and later became known for work on icons, user interfaces, and visual programming.
...
Van Weingarten is an unverified transcript name connected with Euler-era programming-language simplification. Check this against the audio or source transcript before treating it as confirmed.

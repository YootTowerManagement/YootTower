...
The almost-[OOP](Technologies.md#object-oriented-programming-oop) idea started early, as designers found that the straightforward material-and-recipe metaphors of data structures and procedures broke down all too readily under stress.
1962-1964
...
B 5000
Barton
[Sketchpad](Technologies.md#sketchpad)
Sutherland
B220 COBOL Comp. Conway
1964-1967
general simulation: proc classes & instances
[Simula](Technologies.md#simula)
Nygaard, [Dahl](People.md#ole-johan-dahl-university-of-oslo)
1967-1969
subsuming programming constructs
[FLEX](Technologies.md#flex-machine)
Kay
1967-*
inheritance
[Simula-67](Technologies.md#simula-67)
...
[PLANNER](Technologies.md#planner)
CDL
Hewitt
Fisher
...
This led to the formation of the [ARPA](Institutions.md#arpa-advanced-research-projects-agency) IPT office that in the sixties funded most of the advanced computer research in the US. Perhaps as important is that these visions were also adopted by other funders such as ONR and NIH.
...
[LINC](Technologies.md#linc-laboratory-instrument-computer)
Clark
1962-1967?
...
FSL, [META II](Technologies.md#meta-ii), IMP, Feldman, Shorre,

EL1
Trons, Wegbreit
formal models of prog
CPL, [ISWIM](Technologies.md#iswim),
Strachey, Landin,
postALGOL, DS definitions
[GEDANKEN](Technologies.md#gedanken)
Reynolds
[ALGOL](Technologies.md#algol)-W,
Wirth, Hoare,
...
[Smalltalk](Technologies.md#smalltalk) Documentation
...
miniCOM documents
Sum 1971
early [Smalltalk-71](Technologies.md#smalltalk) programs
Sum 1971
first LRG plan
Fall 1971
first LRG report
...
Sept 1972
First [Smalltalk-72](Technologies.md#smalltalk) "one page" interpreter demonstration
Oct 1972
First Smalltalk-72 programs run (D. Ingalls)
Nov 1972
A Dynamic Medium For Creative Thought, NCTE Conference "20 things to do with a [Dynabook](Technologies.md#dynabook)"
This was pretty much what I wanted the group to accomplish (except for music, etc.)
Nov 1972
Presentation to [MIT](Institutions.md#mit-massachusetts-institute-of-technology) Al Lab of Smalltalk and its interpreter
Nov 1972
[Stewart Brand](People.md#stewart-brand-stanford-university-rolling-stone-whole-earth-catalog-long-now-foundation) Rolling Stone article on PARC-caused blackout of LRG pubs until 1975.
Win 1973
...
1973-1975
Many application documentation notes, written by [Ted Kaehler](People.md#ted-kaehler-stanford-university-xerox-parc-apple-inc-viewpoints-research-institute), Diana Merry, etc.
1974
minimouse ([Larry Tesler](People.md#larry-tesler-stanford-university-xerox-parc-apple-inc-amazon-yahoo))
??
...
proposal to [NSF](Institutions.md#national-science-foundation-nsf) for funding longitudinal studies of children
1975
PYGMALION *** ([David Canfield Smith](People.md#david-canfield-smith-oberlin-college-stanford-university-xerox-parc-stanford-ai-lab-sri-visicorp-dest-systems-cognition-apple-inc-stagecast-ibm)), Ph.D. Thesis, Stanford, also as ???
1976
Dynamic Personal Media (with Adele)
...
Findit (with [Steve Weyer](People.md#steve-weyer-xerox-parc)), presented at "Dulles" learning center
1977
...
1977
[Smalltalk-76](Technologies.md#smalltalk) Listing (Dan Ingalls + Dave Robson, Ted Kaehler, Diana Merry)
...
1978
Smalltalk-76 ([Dan Ingalls](People.md#dan-ingalls-harvard-stanford-university-xerox-parc-apple-inc-interval-research-corporation)), ACM POPL Conference, January
1979
...
1979
The Programming Language Smalltalk-72 ([John Shoch](People.md#john-shoch-stanford-university-xerox-parc)),
冬*米水*
*, Paris
1980
...
[Borning, 1979] Borning, Alan. Thinglab—A constraint-oriented simulation laboratory, Xerox [Palo Alto Research Center](Institutions.md#xerox-parc-palo-alto-research-center),
#SSL-79-3, July 1979.
[Brand, 1972] Brand, Stewart. Fanatic life & symbolic death among the computer bums, Rolling Stone Magazine, Dec. 1972.
[Burroughs, 1961] Burroughs Corp. The Descriptor—a definition of the [B5000](Technologies.md#b5000) information processing system, Detroit,
...
[Goldberg, 1983] Goldberg, Adele, Kay, Alan C. and Robson, D. [Smalltalk-80](Technologies.md#smalltalk): The Language and its Implementation, Reading,
...
[Project MAC](Technologies.md#project-mac)., AT memo #168, 1969.
[Hewitt, 1973]
...
[Kay, 1972b
. Learning research group 3 year plan, Xerox Palo [Alto](Technologies.md#xerox-alto) Research Center, May 1972
[Kay, 1972c]
...
[Rovner, 1968] Rovner, P. D. An [AMBIT/G](Technologies.md#ambitg) programming language implementation, MIT Lincoln Laboratory, Lexington, MA,
June 1968.
...
[Van Wijngaarden, 1968] Van Wijngaarden, A., Ed., Draft Report on [ALGOL 68](Technologies.md#algol-68), Mathematisch Centrum, MR 93, Amsterdam,
...
![Slide 1](Appendix-VI-Slide-1.png)

(SLIDE 1) At PARC in 1974-forget about these firsts—the word "first" doesn't matter; arguably, we had the first PC workstation, first overlapping window interface, first modern OOP, first laser printer, and first packet-switching LAN. One of the interesting things about PARC—and I'm going to get into this a little bit—is that, for example, the PC workstation was done by a couple of people in the Computer Science Lab with some data from me. Our group, the Learning Research Group, did the user interface and Smalltalk. The [Ethernet](Technologies.md#ethernet) was done by one person in one lab and one person in another lab. And the laser printer was done by a person in yet a third lab. And in fact, there was no supreme plan of any kind, having to do with management coordination. The whole shebang was done
...
![Slide 2A](Appendix-VI-Slide-2a.png)
...
![Slide 2B](Appendix-VI-Slide-2b.png)
...
![Slide 2C](Appendix-VI-Slide-2c.png)
...
![Slide 3B](Appendix-VI-Slide-3b.png)
...
![Slide 3C](Appendix-VI-Slide-3c.png)
...
![Slide 4](Appendix-VI-Slide-4.png)
...
![Slide 7](Appendix-VI-Slide-7.png)
...
![Slide 8](Appendix-VI-Slide-8.png)
...
![Slide 9](Appendix-VI-Slide-9.png)
...
![Slide 10](Appendix-VI-Slide-10.png)
...
![Slide 11](Appendix-VI-Slide-11.png)
...
![Slide 12](Appendix-VI-Slide-12.png)

(SLIDE 12) Here is Ivan. I once asked him, "How could you possibly have done the first object-oriented software system, the first graphics system, and the first constraint solving system, all in one year?" He said, "Well, I didn't know it was hard." In fact, according to [Wes Clark](People.md#wesley-a-clark-uc-berkeley-linc-mit-mit-lincoln-laboratory-washington-university-clark-rockoff-and-associates), the genesis of Sketchpad was when Ivan went out to Lincoln Labs and saw how bad the display was on the TX-2.
...
![Slide 13](Appendix-VI-Slide-13.png)
...
![Slide 14](Appendix-VI-Slide-14.png)

(SLIDE 14) The best book on complex system design. Think about it.


![Slide 15](Appendix-VI-Slide-15.png)

![Slide 16](Appendix-VI-Slide-16.png)
...
Now, the grownups are also doing things. This is the animation system done by [Steve Purcell](People.md#steve-purcell-xerox-parc)—un-fortunately, quite superior to what you can still do on the Macintosh. The ALTO is very powerful doing this.
...
![Slide 1](Appendix-VI-Goldberg-Slide-1.png)
...
![Slide 2](Appendix-VI-Goldberg-Slide-2.png)
...
![Slide 3](Appendix-VI-Goldberg-Slide-3.png)
...
![Slide 4](Appendix-VI-Goldberg-Slide-4.png)
...
![Slide 5](Appendix-VI-Goldberg-Slide-5.png)
...
![Slide 6](Appendix-VI-Goldberg-Slide-6.png)
...
![Slide 8](Appendix-VI-Goldberg-Slide-8.png)
...
![Slide 9](Appendix-VI-Goldberg-Slide-9.png)
...
![Slide 10](Appendix-VI-Goldberg-Slide-10.png)
...
![Slide 11](Appendix-VI-Goldberg-Slide-11.png)
...
![Slide 12](Appendix-VI-Goldberg-Slide-12.png)
...
![Slide 13](Appendix-VI-Goldberg-Slide-13.png)
...
![Slide 14](Appendix-VI-Goldberg-Slide-14.png)
...
![Slide 17](Appendix-VI-Goldberg-Slide-17.png)
...
developed these ideas into: modern workstations and the forerunners of the [Macintosh](Technologies.md#macintosh), Smalltalk, EtherNet, Laserprinting, and network "client-servers."
Before Xerox, Kay was a member of the University of Utah ARPA research team that developed 3D graphics. His Ph.D. in 1969 was awarded for the development of the first graphical object-oriented personal computer. His undergraduate degrees were in Mathematics and Molecular Biology (from the University of Colorado in 1966). As a member of the ARPA community, he also participated in the early design of the ARPANet (which became the Internet). After Xerox he was Chief Scientist of [Atari](Institutions.md#atari), and from 1984 has been a Fellow at Apple Computer.

> Source and credit: Markdown conversion of [Brett Victor](https://worrydream.com/)'s cleaned-up HTML edition of [Alan Kay](People.md#alan-kay-university-of-colorado-at-boulder-university-of-utah-xerox-parc-atari-apple-viewpoints-research-institute)'s HOPL paper, [The Early History Of Smalltalk](https://worrydream.com/EarlyHistoryOfSmalltalk/). The local Markdown and `EarlyHistoryOfSmalltalk-*` PNG files are derived from Brett's public [worrydream/EarlyHistoryOfSmalltalk](https://github.com/worrydream/EarlyHistoryOfSmalltalk) repository. Original publication/copyright notices from the source text are preserved below.
